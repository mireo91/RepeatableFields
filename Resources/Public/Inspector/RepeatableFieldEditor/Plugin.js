...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react */ "./node_modules/@neos-project/neos-ui-extensibility/src/shims/vendor/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! react-dom */ "./node_modules/@neos-project/neos-ui-extensibility/src/shims/vendor/react-dom/index.js");
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! prop-types */ "./node_modules/@neos-project/neos-ui-extensibility/src/shims/vendor/prop-types/index.js");
...
var Envelope = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
...
}), _dec(_class = (_temp2 = _class2 = class Envelope extends _react.PureComponent {
  constructor() {
    var _temp, _this;

    return _temp = _this = super(...arguments), this.commit = function (event, hook) {
      var _props = _this.props,
          commit = _props.commit,
          id = _props.id,
          property = _props.property,
          hooksRegistry = _props.hooksRegistry;
  ...
  render() {
    ...
    return _react2.default.createElement(EditorEnvelope, _extends({ commit: this.commit }, restProps));
  }
}, _class2.propTypes = {
...
var _Sortable = __webpack_require__(/*! ./Sortable */ "./src/View/Sortable.js");

var _Sortable2 = _interopRequireDefault(_Sortable);

var _Envelope = __webpack_require__(/*! ./Envelope */ "./src/View/Envelope.js");
...
var _arrayMove = __webpack_require__(/*! array-move */ "./node_modules/array-move/index.js");
...
var Repeatable = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
...
})), _dec(_class = _dec2(_class = (_temp = _class2 = class Repeatable extends _react.PureComponent {

  componentDidMount() {
    var _this = this;

    this.loadRepeatableOptions(function () {
      _this.setState({ isLoading: true });
      _neosUiBackendConnector2.default.get().endpoints.dataSource("get-property-types", null, {}).then(function (json) {
        _this.initialValue();
        var value = _this.getValue();
        _this.testIfAdd(value);
        _this.testIfRemove(value);
        _this.setState({ dataTypes: json, isLoading: false });
      });
    });
  }
  ...
  loadRepeatableOptions(callback) {
    ...
    if (this.props.options.dataSourceIdentifier || this.props.options.dataSourceUri) {
      ...
      this.props.dataSourcesDataLoader.resolveValue(getDataLoaderOptionsForProps(this.props), this.getValue()).then(function (selectBoxOptions) {
        _this3.props.options = (0, _lodash2.default)(JSON.parse(JSON.stringify(_this3.props.options)), selectBoxOptions);
        callback();
  ...
  constructor(props) {
    ...
    this.initialValue = function () {
      ...
      if (currentValue.length > 0) {
        for (var key = 0; key < currentValue.length; key++) {
          ...
          }).reduce(function (cur, keyname) {
            var source = _defineProperty({}, keyname, test[keyname]);
            if (options.predefinedProperties && options.predefinedProperties[key] && options.predefinedProperties[key].properties && options.predefinedProperties[key].properties.hasOwnProperty(keyname) && options.predefinedProperties[key].properties[keyname].defaultValue) {
    ...
    this.validateElement = function (elementValue, elementConfiguration, idx, identifier) {
      if (elementConfiguration && elementConfiguration.validation) {
        ...
        var validationResultsArray = validationResults.filter(function (result) {
          return result;
        });
        if (_this4.props.options.controls.add) {
    ...
    this.createElement = function (idx) {
      ...
      var _state = _this4.state,
          allowRemove = _state.allowRemove,
          currentValue = _state.currentValue;

      var isPredefined = options.predefinedProperties && options.predefinedProperties[idx] ? true : false;
      var DragHandle = (0, _reactSortableHoc.SortableHandle)(function () {
        return _react2.default.createElement(
          "span",
          { type: "button", className: _style2.default.move },
          _react2.default.createElement(_reactUiComponents.Icon, { icon: "sort" })
        );
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { "class": _style2.default.buttons },
          !isPredefined && options.controls.move && currentValue.length > 1 ? _react2.default.createElement(DragHandle, null) : "",
          !isPredefined && options.controls.remove && allowRemove ? _react2.default.createElement(_reactUiComponents.IconButton, {
            onClick: function onClick() {
              return _this4.handleRemove(idx);
            },
            className: _style2.default.delete,
            icon: "trash"
          }) : ""
        ),
    ...
    this.getProperties = function (idx) {
      var groupLabel = _this4.props.options.predefinedProperties && _this4.props.options.predefinedProperties[idx] ? _this4.props.options.predefinedProperties[idx].label : null;
      var properties = [];
      ...
      return _react2.default.createElement(
        "div",
        { className: "group" },
        _react2.default.createElement("td", { dangerouslySetInnerHTML: { __html: _this4.state.actions } }),
        groupLabel ? _react2.default.createElement("span", { dangerouslySetInnerHTML: { __html: groupLabel } }) : "",
        properties
      );
    };
    ...
    this.getProperty = function (property, idx) {
      var _state2 = _this4.state,
          ...
          dataSourceConf = _state2.dataSourceConf;

      // console.log('getProperty');

      var repeatableValue = _this4.getValue();
      var propertyDefinition = _this4.props.options.properties[property];
      if (_this4.props.options.predefinedProperties && _this4.props.options.predefinedProperties[idx] && _this4.props.options.predefinedProperties[idx]["properties"] && _this4.props.options.predefinedProperties[idx]["properties"][property]) {
        propertyDefinition = (0, _lodash2.default)(JSON.parse(JSON.stringify(propertyDefinition)), _this4.props.options.predefinedProperties[idx]["properties"][property]);
      ...
      if (defaultDataType) {
        (0, _lodash2.default)(propertyDefinition, defaultDataType);
      }
      ...
      if (editorOptions.hasOwnProperty("dataSourceUri") || editorOptions.hasOwnProperty("dataSourceIdentifier")) {
        ...
        if (editorOptions.dataSourceAdditionalData.hasOwnProperty("repeatableIndex")) editorOptions.dataSourceAdditionalData["repeatableIndex"] = idx;
        if (editorOptions.dataSourceAdditionalData.hasOwnProperty("repeatableValue")) editorOptions.dataSourceAdditionalData["repeatableValue"] = _this4.getValue();
      }
      return _react2.default.createElement(
        "div",
        { className: _style2.default.property, hidden: propertyDefinition.hidden },
        _react2.default.createElement(_Envelope2.default, _extends({
    ...
    this.onSortAction = function (_ref) {
      ...
      _this4.handleValueChange((0, _arrayMove.arrayMoveImmutable)(_this4.getValue(), oldIndex, newIndex));
    };
    ...
    this.loadRepeatableOptions(function () {
      ...
      if (properties) {
        Object.keys(properties).map(function (property, index) {
          _this4.emptyGroup[property] = properties[property].defaultValue ? properties[property].defaultValue : "";
        });
      }
    });
  }
  ...
  options: _propTypes2.default.shape({
    ...
    predefinedProperties: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    ...
    controls: _propTypes2.default.shape({
      move: _propTypes2.default.bool,
      remove: _propTypes2.default.bool,
      add: _propTypes2.default.bool
    })
    //
...
var Sortable = (_temp2 = _class = class Sortable extends _react.PureComponent {
  constructor() {
    var _temp, _this;

    return _temp = _this = super(...arguments), this.createItems = function () {
      var _props = _this.props,
      ...
      items.map(function (value, idx) {
        renderedItems.push(_react2.default.createElement(SortableItem, {
          key: "item-" + idx,
          index: idx,
          collection: "zzzz",
          value: element(idx)
...
var _Repeatable = __webpack_require__(/*! ./View/Repeatable */ "./src/View/Repeatable.js");
...
module.exports = {"wrapper":"style__wrapper___cQFyX","property":"style__property___3P5di","buttons":"style__buttons___1O8ni","delete":"style__delete___3tAu8","move":"style__move___2H6UK"};
